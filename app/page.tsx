            ...
            <div className="relative">
              ...
              <div className="relative bg-white rounded-lg shadow-xl p-8">
                <div className="aspect-video bg-gray-200 rounded-lg mb-4 flex items-center justify-center">
                  <span className="text-gray-500">Tu habitación aquí</span>
                </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-3">Elige tu estilo</h3>
              <p className="text-gray-600">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-semibold mb-3">Diseño con IA</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-semibold mb-3">Múltiples estilos</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-semibold mb-3">Recomendaciones de compra</h3>
              <p className="text-gray-600">
